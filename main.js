...
class Game {
  constructor() {
    ...
    this.texturePizza = PIXI.Texture.fromImage("img/pizza.png");
    this.texturePineapple = PIXI.Texture.fromImage("img/pineapple.png");
    this.textureOkHand = PIXI.Texture.fromImage("img/ok_hand.png");
  ...
  loadProgress() {
    ...
    let count = parseInt(localStorage.getItem(SCORE_KEY));
    this.pineappleCount = count;
    //this.setProgressText();
  }

  saveProgress() {
    localStorage.setItem(SCORE_KEY, this.pineappleCount);
  }
  ...
  saveUpgrades() {
    ...
    localStorage.setItem(UPGRADES_KEY, helpingHands);

    console.log("Saved upgrades...");
  }

  loadUpgrades() {
    let helpingHands = parseInt(localStorage.getItem(UPGRADES_KEY));
